...
export default function ClientSegmentationDashboard() {
  const [dashboardData, setDashboardData] = useState<ClientSegmentationDashboardData | null>(null);
      ...
      <Card>
        <CardHeader>
          <div className="flex justify-between items-start">
            <div>
              <CardTitle className="text-2xl">Client Segmentation Dashboard</CardTitle>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-2xl font-bold">{dashboardData.kpis.clientCount.value}</p>
                <p className="text-sm text-muted-foreground">{dashboardData.kpis.clientCount.label}</p>
              </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-2xl font-bold">{dashboardData.kpis.totalAUM.value}</p>
                <p className="text-sm text-muted-foreground">{dashboardData.kpis.totalAUM.label}</p>
              </div>
        ...
        <Card>
          <CardContent className="p-6">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-2xl font-bold">{dashboardData.kpis.averageClientAUM.value}</p>
                <p className="text-sm text-muted-foreground">{dashboardData.kpis.averageClientAUM.label}</p>
              </div>
