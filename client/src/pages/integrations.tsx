      ...
      {!isAuthorized && (
        <Alert className="mb-6 bg-yellow-50 border-yellow-200">
          ...
          <AlertDescription className="text-yellow-700">
            WealthBox integration is only available to client administrators.
        ...
        <CardHeader>
          <div className="flex items-center">
            ...
            <div>
              ...
              <CardDescription>
                Resources for setting up your WealthBox integration
              </CardDescription>
            </div>
          </div>
        </CardHeader>
          ...
          <div className="space-y-4">
            <div>
              <h3 className="text-md font-medium mb-2">
                WealthBox API Integration Guide
              </h3>
              <p className="text-sm text-gray-600">
                {isAuthorized
                  ? "To use this integration, you need a personal API access token from your WealthBox account. Enter your token in the field above, test the connection, and then import your data. This integration will synchronize your client data between WealthBox and Vitals AI."
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button variant="outline" className="flex items-center" asChild>
                <a
                  href="https://api.crmworkspace.com/docs"
                  target="_blank"
              ...
              <Button variant="outline" className="flex items-center" asChild>
                <a
                  href="https://help.wealthbox.com/en/articles/2344281-api-access-token"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <svg
