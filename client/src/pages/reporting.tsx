...
export interface Report {
  ...
  status?: 'Coming Soon';
  isFavorite?: boolean;
  // Add a slug or unique identifier for routing if 'id' isn't URL-friendly
  // For now, we'll assume 'id' can be used, but often a slug like 'age-demographics' is better.
  routePath?: string; 
}

const initialMockReports: Report[] = [
  { id: '1', name: 'Age Demographics', routePath: 'age-demographics', description: 'Visualize your client base by age groups to identify opportunities.', integrations: 'Data Sources', isFavorite: false },
  { id: '2', name: 'Birthday Report', routePath: 'birthday-report', description: 'Track upcoming client birthdays for timely engagement.', integrations: 'Data Sources', isFavorite: false },
  { id: '3', name: 'Book Development', description: 'Visualize client growth and assets under management over time.', integrations: 'Data Sources', isFavorite: false },
  { id: '4', name: 'Client Inception Report', description: 'Analyze when clients joined your practice.', integrations: 'Data Sources', isFavorite: false },
  { id: '5', name: 'Client Segmentation Report', description: 'Visualize client segmentation across different categories.', integrations: 'Data Sources', isFavorite: false },
  { id: '6', name: 'Geographic Footprint', description: 'View your client base and book of business by geography.', integrations: 'Data Sources', status: 'Coming Soon' },
  { id: '7', name: 'Net New Assets', description: 'Track growth of assets under management over time.', integrations: 'Data Sources', isFavorite: false },
  { id: '8', name: 'Referral Analytics', description: 'Track referral sources and conversion rates.', integrations: 'Data Sources', isFavorite: false },
  { id: '9', name: 'Revenue vs Client Expense', description: 'Compare client revenue against expenses over time.', integrations: 'Data Sources', isFavorite: false },
];
...
export default function Reporting() {
  ...
  const toggleFavorite = useCallback((reportId: string) => {
    ...
    const title = wasFavoriteForToast ? 'Removed from favorites' : 'Added to favorites';
    const description = `${reportNameForToast} has been ${wasFavoriteForToast ? 'removed from' : 'added to'} your favorites.`;
    ...
    <div className="p-6 space-y-6">
      ...
      <div>
        ...
        <div>
          ...
          {favoriteReports.length > 0 && nonFavoriteReports.length === 0 && searchTerm && (
