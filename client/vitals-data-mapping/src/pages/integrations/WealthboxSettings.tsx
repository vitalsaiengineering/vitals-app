...
const WealthboxSettings: React.FC = () => {
  ...
  const [sections, setSections] = useState<MappingSection[]>([
    {
      ...
      mappings: [
        ...
        },
        {
          ...
          sourceLabel: 'Which field indicates a Lost Client of the firm?',
          targetField: 'status_lost',
          targetOptions: [
            { label: 'Status: Lost', value: 'status_lost' },
            { label: 'Former Client', value: 'former_client' },
            { label: 'Terminated', value: 'terminated' },
            { label: 'Inactive Status', value: 'inactive_status' },
          ],
        },
        {
          sourceField: 'deceasedClient',
          sourceLabel: 'Which field indicates a Deceased Client of the firm?',
          targetField: 'status_deceased',
          targetOptions: [
            { label: 'Status: Deceased', value: 'status_deceased' },
            { label: 'Deceased Flag', value: 'deceased_flag' },
            { label: 'Death Date', value: 'death_date' },
            { label: 'Deceased Status', value: 'deceased_status' },
          ],
        },
        {
...
export default WealthboxSettings;
